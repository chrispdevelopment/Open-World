...
bool ApplicationClass::Initialize(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight)
{
	...
	result = m_TextureManager->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), "data/textureinfo.txt");
	if (!result)
	{
	...
	result = m_Zone->Initialize(m_Direct3D, hwnd, m_TextureManager, screenWidth, screenHeight, SCREEN_DEPTH);
	if(!result)
	{
